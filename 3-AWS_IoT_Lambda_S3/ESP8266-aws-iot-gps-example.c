 ...
 * Modified for 'Serverless IoT on AWS' course on Udemy by Stephen Borsay
...
const char *awsEndpoint = "YOUR-AWS-REGION-SPECIFIC-ENDPOINT.amazonaws.com";
...
const String certificatePemCrt = //-----BEGIN CERTIFICATE-----
    "XXXXXXXXXXXXAwIBAgIVAI7n0dti6sMuimCVANnjs+8i8TUiMA0GCSqGSIb3DQEB"
...
const String privatePemKey = //-----BEGIN RSA PRIVATE KEY-----
    "XXXXXXXXXXXXAQEA0UlgP9sUoPzmDjjOndrJiSBJ91SIJqghJq4Nfur3aCgS8YDI"
...
const String caPemCrt = //-----BEGIN CERTIFICATE-----
...
void setCurrentTime()
{
    configTime(3 * 3600, 0, "pool.ntp.org" /*"1.north-america.pool.ntp.org"*/, "time.nist.gov");
